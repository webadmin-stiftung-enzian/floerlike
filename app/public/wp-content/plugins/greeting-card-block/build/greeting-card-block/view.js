...
(() => {
/*!*****************************************!*\
  !*** ./src/greeting-card-block/view.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
const {
  state
} = (0,_wordpress_interactivity__WEBPACK_IMPORTED_MODULE_5__.store)('greeting-card-block', {
  state: {
    get charCounter() {
    ...
    get isValid() {
      return !state.wantsCard || state.selectedCardId !== '' && state.text.trim() !== '';
    },
    get showCardError() {
...
document.addEventListener('submit', event => {
  ...
  if (!(form instanceof HTMLElement) || !form.matches('form.wp-block-woocommerce-add-to-cart-with-options, form.cart')) {
    return;
  }
